...
class VisMatplotlib:
    def __init__(self):
        ...
        # obstacles = []
        # radius = 0.3*np.sqrt(2)
        # obstacles.append( np.array([-1.2,-0.6]) ) 
        # obstacles.append( np.array([-0.3,1.2]))
        # obstacles.append( np.array([0.6,-0.6]))
        # obstacles.append( np.array([1,2,0.6]))

        # for aa in obstacles:
        #     circle1 =plt.Circle((aa[0],aa[1]),radius,linewidth = 1, edgecolor='k',facecolor='k')
